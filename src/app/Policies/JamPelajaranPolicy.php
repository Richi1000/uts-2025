...
class JamPelajaranPolicy
{
    ...
    {
        return $user->can('view_any_jam::pelajaran');
    }
    ...
    {
        return $user->can('view_jam::pelajaran');
    }
    ...
    {
        return $user->can('create_jam::pelajaran');
    }
    ...
    {
        return $user->can('update_jam::pelajaran');
    }
    ...
    {
        return $user->can('delete_jam::pelajaran');
    }
    ...
    {
        return $user->can('delete_any_jam::pelajaran');
    }
